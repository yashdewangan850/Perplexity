...
const Dashboard = () => {
  ...
  const openChat = (chatId) => {
    ...
    // Mobile par chat open hone ke baad sidebar close
        ...
        >
          ...
          <div className="border-t border-white/[0.06] p-4">
            <div className="flex items-center gap-3 rounded-xl px-2 py-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-white/20 to-white/5 text-xs font-medium">
                Y
              </div>
